    ...
    $.each(data, function (i) {
        ...
        if (row.parentGuid == "0") {
            ...
            if (childNodes.length == 0) {
                _html += '<a class="J_menuItem" href="' + row.moduleUri + '"><i class="' + row.moduleIcon + '"></i><span>' + row.moduleName + '</span></a>';
            } else {
                ...
                $.each(childNodes, function (i) {
                    ...
                    _html += '<li>';
                    _html += '<a class="J_menuItem" href="' + subrow.moduleUri + '"><i class="' + subrow.moduleIcon + '"></i><span>' + subrow.moduleName + '</span></a>';
                    _html += '</li>';
                });
                _html += '</ul>';
            }
